    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Home.this,CreateProjectActivity.class);
        ...
        String urlG = url + "api/getMyProjects?user_id=1";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, urlG, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    a1=new AdapterHome(Home.this, ListProjects, Home.this);
